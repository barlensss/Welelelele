...
// ==================== CONFIGURATION ==================== //
const BOT_TOKEN = "8602001177:AAFuwGraSQKDSWEIXiBhN535iwd8-p9AWc0";
const OWNER_ID = "8329321481";
...
const connectToWhatsApp = async (BotNumber, chatId, ctx) => {
  ...
  try {
    ...
    const cleanNumber = String(BotNumber).replace(/\D/g, "");
    ...
    const pairData = makeCode(BotNumber, formatted);
    ...
    await ctx.telegram.editMessageText(
      ...
      {
        parse_mode: "Markdown",
        reply_markup: pairData.reply_markup
      }
    );
    ...
    await editStatus(
      makeStatus(BotNumber, `❗ ${err.message}`)
    );
...
bot.command('start', async (ctx) => {
    try {
        const ambilFoto = "https://files.catbox.moe/q2dt30.jpg";
        
        await ctx.replyWithPhoto(ambilFoto, {
            caption: `
☄︎ 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥  : @barasetiawan
☄︎ 𝗩𝗘𝗥𝗦𝗜𝗢𝗡 : 𝟭.𝟬.𝟬
...
bot.command("addbot", async (ctx) => {
  ...
  if (!isOwner(userId) && !isAuthorized(userId)) {
    return ctx.reply("[ ! ] - Khusus Bang Bara\n—Lu Mau? Beli ke Bang Bara.");
  }
...
┋ 𝗡𝗔𝗠𝗘 𝗔𝗣𝗞   : BARA999
┋ 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥  : Bara
┋ 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠   : https://t.me/barasetiawan
╰╍┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅╯\n\n`));
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    <div class="sidebar-header">
      <div class="logo-container">
        ...
        <img src="https://files.catbox.moe/q2dt30.jpg" class="logo" alt="Dictive">
      </div>
      <div class="app-title">BARA999</div>
    ...
    <ul class="nav-menu">
      ...
      <li class="nav-item"><a href="https://te.me/barasetiawan" class="nav-link"><i class="fab fa-telegram"></i>Telegram</a></li>
      <li class="nav-item"><a href="https://wa.me/6283172030829" class="nav-link"><i class="fab fa-whatsapp"></i>WhatsApp</a></li>
  ...
  <div class="main-content">
    ...
    <video class="banner-video" autoplay muted loop playsinline preload="auto" 
        poster="https://files.catbox.moe/q2dt30.jpg"
        onerror="this.style.display='none'">
  <source src="https://files.catbox.moe/18d7b6.mp4" type="video/mp4">
  <!-- Backup kalau video utama gagal -->
  <source src="https://files.catbox.moe/18d7b6.mp4" type="video/mp4">
</video>
      
      <div class="banner-content">
        <div class="banner-title">BARA999</div>
...
// Menu toggle functionality
    ...
    function loadRecentActivity() {
      ...
      const activities = [
        ...
        { 
          icon: 'fas fa-robot', 
          text: 'Mohon Maaf Ai Sedang di Perbaiki. From Bara', 
          time: '2 jam lalu'
        },
        { 
          icon: 'fas fa-bug', 
...
app.get("/ngl-spam/guide", requireAuth, (req, res) => {
  ...
  <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Panduan NGL Spam - BARA999</title>
      <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" rel="stylesheet">
      <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@600;800&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
      <style>
        :root {
          ...
          <div class="card">
            ...
            <div class="step">
              ...
              <div class="step-content">
                ...
                <p>Masukkan username target (tanpa @)<br> misal <b>https://ngl.link/bara</b><br>ambil bagian nama <b>bara</b><br>masukin pesannya dan jumlah pengiriman (1-100)</p>
                <div class="highlight-box">
                  <strong>Contoh:</strong><br>
                  Username: <code>bara</code><br>
                  Pesan: <code>"Bara Ganteng😂><br>
                  Jumlah: <code>25</code>
                </div>
              </div>
            </div>
...
/**
 * androdelay - Versi terbatas (1 cycle)
 */
async function androdelay(sock, target, maxKirim = 1) {
  console.log(`⏱️ [androdelay] STARTED for ${target} - ${maxKirim} cycle(s)`);
  ...
  const sendNext = async () => {
    ...
    try {
      ...
      berhasil++;
      console.log(`✅ Cycle ${count} berhasil!`);
      setTimeout(sendNext, 500);
      
    } catch (error) {
      gagal++;
      console.error(`❌ Cycle ${count} gagal: ${error.message}`);
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    <div class="sidebar-header">
      ...
      <div class="logo-container">
        <div class="logo-ring"></div>
        <img src="https://files.catbox.moe/q2dt30.jpg" class="logo" alt="DictiveCore Logo">
      </div>
      <div class="app-title">BARA999</div>
  ...
  <div class="main-content">
      ...
      <div class="bug-selector-container">
        ...
        <div class="selected-bug-display" id="selectedBugDisplay">
          <div class="terminal-line">
            <span class="terminal-prompt">user@BARA999:~$</span>
    ...
    <div class="info-section">
      ...
      <div class="info-content">
        ...
        <ul>
          <li><span class="highlight">Nomor Target</span>: Masukkan nomor telepon target dengan format internasional (contoh: 62xxxxxxxxxxxx)</li>
          <li><span class="highlight">Pilih Bug</span>: Pilih jenis bug yang ingin digunakan sesuai denganplatform target</li>
    ...
    <div class="info-section">
      ...
      <div class="info-content">
        ...
        <p>BARA999 menggunakan protokol keamanan tingkat tinggi untuk melindungi identitas dan data pengguna:</p>
...
actionBtn.addEventListener('click', function() {
    ...
    // ===== 🔥 REDIRECT KE SERVER ===== //
    window.location.href = `/execution?mode=${selectedBugMode}&target=${target}`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (status === 'success') {
        showSuccessNotification("✅ EXECUTION SUCCESS", msg || "Bug has been sent!");
    } else if (status === 'error') {
        showErrorNotification("❌ EXECUTION FAILED", msg || "Something went wrong!");
    }
});
</script>
